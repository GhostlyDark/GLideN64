...
# ifdef _DEBUG
	sprintf(caption, "%s Debug Revision %s (old cache format)", pluginName, PLUGIN_REVISION);
# else // _DEBUG
	sprintf(caption, "%s Revision %s (old cache format)", pluginName, PLUGIN_REVISION);
# endif // _DEBUG
